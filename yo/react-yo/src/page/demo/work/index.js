...
class Work extends Component {
    ...
    componentWillMount(){
        var that=this;
        axios.get('http://chinayj.online/yophp/works.php')
        .then(function(res){
	...
	render() {
        return (
            <div className="yo-flex"  >
                <Header title="Work" right={{ title: <i className="yo-ico iconfont icon-saomiao3"></i>, onTap: () => scan() }} /> 
